...
namespace LabFontInternal {
    ...
    FONScontext* fontStash()
    {
        ...
        static FONScontext* fons_context = 
            sfons_create(atlas_dim, atlas_dim, FONS_ZERO_TOPLEFT);
        return fons_context;
    }
...
float LabFontDraw(LabFontDrawState*, const char* str, float x, float y, LabFontState* fs)
{
    if (!fs || !str)
        return x;
