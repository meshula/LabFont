...
typedef struct LabImmPlatformContext {
     ...
     id<MTLTexture> atlasTexture[ATLAS_SLOT_MAX];
...
void LabImmDrawSetRenderTargetPixelFormat(LabImmPlatformContext*  mtl,
        MTLPixelFormat pixelFormat) {
...
void lab_imm_MTLRenderCommandEncoder_set(LabImmPlatformContext*  mtl,
